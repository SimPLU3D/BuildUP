...
//    p->template insert<bool>("dosave",'b',false, "Save intermediate results");
    p-> template insert<int>("nbsave_energy",'s',100,"Number of iterations between each save");
    p-> template insert<int>("nbsave_bldg",'s',1000,"Number of iterations between each save");

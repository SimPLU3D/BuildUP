...
//    p->template insert<bool>("dosave",'b',false, "Save intermediate results");
    ...
    p-> template insert<int>("nbsave_geom",'s',5000,"Number of iterations between each save of geometry");
    p-> template insert<int>("nbsave_config",'s',100,"Number of iterations between each check/save of config");

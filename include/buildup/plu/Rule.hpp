...
public:
//sets
    inline void hMin(double h)
    {
        _hMin=h;
    }
    inline void hMax(double h)
    {
        _hMax=h;
    }
    inline void hFloor(double h)
    {
        _hFloor=h;
    }
    ...
    inline void strH(const char* s)
    {
        _strH = s;
    }
    inline void strW(const char* s)
    {
        _strW = s;
    }
...
//gets
    ...
    inline double hFloor() const
    {
        return _hFloor;
    }
    inline std::vector<double>& rho()
    {
        return _rho;
    }
    inline double rhoMin() const
    {
        return _rhoMin;
    }
    ...
    inline const char* strH() const
    {
        return _strH;
    }
    inline const char* strW() const
    {
        return _strW;
    }
};
...
public:
    ...
    virtual ~RuleEnergy()
    {
        if(_constraint!=NULL) delete _constraint;
    }

    inline RuleType ruleType() const
    {
        return _type;
    }
    inline const char* ruleString() const
    {
        return _string;
    }

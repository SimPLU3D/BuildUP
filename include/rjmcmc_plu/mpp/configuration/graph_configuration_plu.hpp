...
namespace marked_point_process {
	...
	inline void clear() { m_graph.clear(); m_dBorder=m_dPair=m_hDiff=m_lcr=m_far=0.; }

    inline void clear_delta(){m_delta_lcr=0.;m_delta_far=0.;m_delta_dBorder=0.;m_delta_dPair=0.;m_delta_hDiff = 0.;}
